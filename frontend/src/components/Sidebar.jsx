 ...
 // Fetch users only once
      ...
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          ...
          <img 
             ...
             alt="logo"  
             className="w-10 h-auto object-contain bg-transparent relative top-0"
           />
           <span className="text-white font-semibold text-lg">NexChat</span>
          </div>

          {/* Menu */}
          <div className='relative py-2 group'>
            <img src={assets.menu_icon} alt="menu" className='max-h-5 cursor-pointer' />
            <div className='absolute top-[120%] right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gray-100 hidden group-hover:block'>
    ...
    <div className='flex flex-col'>
        {filteredUsers.map((user,index)=>(
          ...
          cursor-pointer max-sm:text-sm ${selectedUser?._id===user._id ? 'bg-[#282142]/50' : 'hover:bg-[#282142]/30'}`}>
